...
TestPoiseuille::TestPoiseuille(const int argc, const char ** argv, const int bpd) : Test(argc, argv, bpd), dtCFL(0), dtFourier(0), time(0), nu(0.01), endTime(10), step(0), rank(0), nprocs(1)
{
