...
class KernelSGS_DSM
{
 ...
 public:
  ...
  const StencilInfo stencil = StencilInfo(-3,-3,-3, 4,4,4, true, 3, FE_U,FE_V,FE_W);
...
class KernelSGS_DSM_avg
{
 ...
 public:
  const std::array<int, 3> stencil_start = {-1, -1, -1};
  const std::array<int, 3> stencil_end = {2, 2, 2};
  const StencilInfo stencil = StencilInfo(-1,-1,-1, 2,2,2, true, 3, FE_U,FE_V,FE_W);
...
class KernelSGS_apply
{
 ...
 public:
  ...
  const StencilInfo stencil = StencilInfo(0,0,0, 1,1,1, false, 3, FE_U,FE_V,FE_W);
