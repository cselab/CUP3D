...
void PoissonSolverAMR_CG::Get_LHS (bool useX)
{
...
void PoissonSolverAMR_CG::solve()
{
  sim.startProfiler("PoissonSolverAMR_CG cub2rhs");
  _cub2fftw();
  sim.stopProfiler();
  ...
  assert (N == PoissonSolverAMR::data.size());
...
#ifdef PRECOND
double PoissonSolverAMR_CG::getA_local(int I1,int I2)
{
  static constexpr int BSX = BlockType::sizeX;
  static constexpr int BSY = BlockType::sizeY;
...
PoissonSolverAMR_CG::PoissonSolverAMR_CG(SimulationData& s):PoissonSolverAMR(s)
{
...
void PoissonSolverAMR_CG::FindZ()
{
  static constexpr int BSX = BlockType::sizeX;
  static constexpr int BSY = BlockType::sizeY;
  static constexpr int BSZ = BlockType::sizeZ;
...
PoissonSolverAMR_CG::PoissonSolverAMR_CG(SimulationData&s) :PoissonSolverAMR(s)
{
  std::cout << "PoissonSolverAMR_CG (empty) constructor called." << std::endl;
}
#endif
PoissonSolverAMR_CG::~PoissonSolverAMR_CG()
{
  std::cout << "PoissonSolverAMR_CG (empty) destructor called." << std::endl;
}
