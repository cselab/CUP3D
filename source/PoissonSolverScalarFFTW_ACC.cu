...
__global__
void _fourier_filter_kernel(Complex*const __restrict__ data_hat, const int*const N,
                            const int*const osize, const int*const ostart,
                            const Real*const waveFact, const Real scale)
{
...
void _fourier_filter_gpu(Complex*const __restrict__ data_hat, const int N[3],
