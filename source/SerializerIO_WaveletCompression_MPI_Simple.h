...
#pragma omp for
			for(int i = 0; i < NBLOCKS; ++i)
			{
				...
				//wavelet compression
				{
...
#endif
					fpc_compress((char *)mysoabuffer, inbytes, (char *) compressor.compressed_data(), &nbytes, 10);
					//printf("fpc_compress: from %d to %d bytes\n", inbytes, nbytes);
					...
					//fpz_compress3D((void *)mysoabuffer, inbytes, _BLOCKSIZE_, (void *) compressor.compressed_data(), (unsigned int *)&nbytes, (sizeof(Real)==4)?1:0);
