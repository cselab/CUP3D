...
rootDir = '/scratch/daint/cconti/SamaraSP_768_RK2_250316_viz/'

for dirName, subDirList, fileList in os.walk(rootDir):
	print(dirName)
	for f in fileList:
		if f.endswith('.xmf'):
			#frame = re.search('SamaraSP_768_180316_Dora_lowDump-(.+?).xmf', f)
			frame = re.search('SamaraSP_768_RK2_250316_viz-(.+?).xmf', f)
			...
			pathVortD = dirName+'/VorticityD'+frame.group(1)+'.ply'
...
#				computeDerivatives1Display.Slice = 767
#				
...
#				cellDatatoPointData1Display.Slice = 767
#				
#				# hide data in view
...
#				# Properties modified on contour1
#				contour2.Isosurfaces = [25.0]
				
#				# save data
#				SaveData(pathVortD, proxy=contour2)
#				print(pathVortD)
