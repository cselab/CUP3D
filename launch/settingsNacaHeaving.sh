...
FACTORY='
IF3D_NacaOperator L=0.2 thickness=0.12 xpos=0.25 Fheave=1 Aheave=0.05 Fpitch=0 Apitch=0 Ppitch=0 Mpitch=0 bForcedInSimFrame_y=1 bForcedInSimFrame_z=1 bFixFrameOfRef_x=1
'
