...
#Version = "5.0"    # tested succesfully on Fri Nov 13 15:54:52 CET 2015
...
SaveScreenshot(filename = basename + "/coloredSphere_v" + Version + "_00.png", view=view)
...
view.ResetCamera()
# change the pathname to a place where you have write access
SaveScreenshot(filename = basename + "/coloredSphere_v" + Version + "_01.png", view=view)
...
view.ResetCamera()
# change the pathname to a place where you have write access
SaveScreenshot(filename = basename + "/coloredSphere_v" + Version + "_02.png", view=view)
