...
cd ../makefiles/;make clean;make config=debug -j;cd -;export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 8 -minDT 1 -maxDT 1 -test geometry

cd ../makefiles
make clean
make config=production bc=periodic precision=double bs=32 -j
cd ../launch/
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 1 -maxBPD 64 -test diffusion > results_diffusion
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 4 -maxBPD 4 -test gravity > results_gravity
